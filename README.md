...
will swap the conformer lettters assigned to the C&beta; atom of residue 56 in chain A and write the result to a new file called <tt>swapped.pdb</tt>.
<p>
